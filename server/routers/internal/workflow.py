...
class Workflow:
    ...
    def main(self, creds_file: str, google_api_auth_code: str, user_id: str, keywords: List[str], tones: List[str], start_date: Optional[str] = None, end_date: Optional[str] = None):
        #TODO UPDATE DOCS
